package ec.edu.formulario.pucem;
...
import ec.edu.dominio.pucem.Prefecto;
...
public class CrearPrefecto extends JInternalFrame implements ActionListener{
	...
	public CrearPrefecto(List<Prefecto> prefectos) {
		...
		txtNombre.setBounds(97, 23, 170, 19);
		getContentPane().add(txtNombre);
		txtNombre.setColumns(10);

		btnNuevo = new JButton("Nuevo");
		btnNuevo.addActionListener(this);
		btnNuevo.setBounds(50, 72, 117, 25);
		getContentPane().add(btnNuevo);

		btnGuardar = new JButton("Agregar");
		btnGuardar.addActionListener(this);
		btnGuardar.setBounds(239, 72, 117, 25);
		getContentPane().add(btnGuardar);

		btnCancelar = new JButton("Cancelar");
		btnCancelar.addActionListener(this);
		btnCancelar.setBounds(300, 20, 117, 25);
